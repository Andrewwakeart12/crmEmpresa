        ...
        <?php foreach ($resultados as $post): ?>
            <div class="col-lg-4 mt-2">
                <div class="card text-white bg-dark " style="width: 18rem;">
                    <a href="articulo.php?id=<?php echo $post['id'];?>"><img src="<?php echo RUTA;?>/imagenes/<?php echo $post['thumb'];?>" class="card-img-top p-1 pt-3"
                            alt="..."></a>
                    <div class="card-body">
                        ...
                        <p class="card-text thumb"><?php echo $post['extracto'];?>
                        </p>
